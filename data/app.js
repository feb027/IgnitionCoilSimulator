...
function App() {
    const [state, setState] = useState({
        ...
        randomMinDwell: 1.5,
        randomMaxDwell: 4.2,
        randomIntervalSec: 2.0,
        randomTransitionMode: 0,
        randomCurrentRpm: 600,
        randomCurrentDwell: 1.5,
        randomTimeLeftSec: 2.0,
        pulsePerKm: 4000,
        rpmStep: 100,
        stepperSpeed: 50,
        stepperSpinDir: 0,
    ...
    return html`
        <header>
            <div class="title">IGNITION PRO <span style="font-size: 0.65rem; color: var(--neon-cyan); margin-left: 4px; font-weight: normal;">v2.7.0</span></div>
